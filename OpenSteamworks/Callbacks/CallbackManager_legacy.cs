...
//                 idToTypeTime.Start();
//                 var hasType = CallbackMetadata.TryGetTypeFromID(msg.callbackID, out Type? type);
//                 idToTypeTime.Stop();
...
//                 bool loggable = msg.callbackID != CallbackMetadata.HTML_NeedsPaint_t_ID;
...
//                         {
//                             valueString = "(threw an exception)";
//                         }
//                     } else {
//                         valueString = "(null)";
//                     }
                    
//                     Logging.CallbackLogger.Debug("    " + field.Name + ": " + valueString);
//                 }
//             } catch (Exception) {
...
//         RegisterHandler((CallbackHandler<T> handler, T callbackResult) => {
