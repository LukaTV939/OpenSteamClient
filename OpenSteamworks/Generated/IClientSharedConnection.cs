...
public unsafe interface IClientSharedConnection
{
    ...
    public int SendMessage(HSharedConnection connection, void *msg, UInt32 size);  // argc: 3, index: 3, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes1]
    public int SendMessageAndAwaitResponse(HSharedConnection connection, void *msg, UInt32 size);  // argc: 3, index: 4, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes4]
